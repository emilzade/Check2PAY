<template>
  <div class="modal-vue">
    ...
    >
      <div
        :class="{
          'Check-All-Inner-ModalMaximized  justify-content-end': !isMinimized,
          'Check-All-Inner-ModalMinimized justify-content-start': isMinimized,
        }"
        class="d-flex overflow-hidden gap-4 p-1 bg-light border rounded-top align-items-center"
      >
...
export default {
  ...
  created() {
    ...
    //     console.log(this.$refs.container.scrollTop, 'scrollTop')
    //     console.log(this.lastPosition, 'lastPosition')
    //     if (
    //       this.isActive &&
    //       this.lastPosition >= this.$refs.container.scrollHeight
    //     ) {
    //       this.$refs.container.scrollTop = this.$refs.container.scrollHeight
    //     }
    //   }, 10000)
